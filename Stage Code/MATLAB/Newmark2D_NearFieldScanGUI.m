...
%COMMENTED OUT BY TIM - also moved "data" block and save inside _fcn
% [data] = Newmark2D_NearFieldScanE8364C_tunes_fcn(handles.Newmark2D_stage,stagespeed,...
...
% [data] = Newmark2D_NearFieldScanE8364C_tunes_demux_fcn(handles.Newmark2D_stage,stagespeed,...
%     handles.defZeroInXsteps,handles.defZeroInYsteps,xmin,xmax,ymin,ymax,dstep,frequencysamples,...
%     fstart,fstop,switches,IFBandwidth,calfile,measureSparam);
% [data] = Newmark2D_NearFieldScanN5245A_tunes_demux_fcn(handles.Newmark2D_stage,stagespeed,...
%     handles.defZeroInXsteps,handles.defZeroInYsteps,xmin,xmax,ymin,ymax,dstep,frequencysamples,...
%     fstart,fstop,switches,IFBandwidth,calfile,measureSparam);
[data] = Newmark2D_NearFieldScanN5245A_2D_Holography_fcn(handles.Newmark2D_stage,stagespeed,...
    handles.defZeroInXsteps,handles.defZeroInYsteps,xmin,xmax,ymin,ymax,dstep,frequencysamples,...
    fstart,fstop,switches,IFBandwidth,calfile,measureSparam);
%COMMENTED OUT BY TIM - also moved "data" block and save inside _fcn
