function [data] = Newmark2D_NearFieldScanN5245A_2D_Holography_fcn(objg,speedmms,defZeroInXsteps,defZeroInYsteps,...
...
power=3;
savename='Holog2D_square_Panel4';
sParMeas='S21';
data.y_point = 0;
data.z_point = 0;
...
load('C:\Users\LabFloor2\Dropbox (Duke Electric & Comp)\2DMA_Aaron\Mask_files\masksRandom_45on_10000_4.mat')
...
%HARDCODE TO ALLOW ONLY CHANNEL 4!!!!!!!!!!!!!!!!
agilent_11713C_switchdriver_closeAll(hware.vobj_switch)
pause(0.05)
agilent_11713C_switchdriver_openChannelNumbers(hware.vobj_switch,1,4)
pause(0.05)
agilent_11713C_switchdriver_openChannelNumbers(hware.vobj_switch,2,4)
pause(0.05)
...
save(['C:\Users\LabFloor2\Dropbox (Duke Electric & Comp)\2DMA_Aaron\2D Holography Code\Data\OEWG_Response_110619\Square_111819\',...
    savename,'_',date,'_',num2str(a(4)),'_',num2str(a(5))],'data')
